...
- On registration form, POST to `https://smartmed-dmrb.onrender.com/api/auth/register` with JSON body.
- On login form, POST to `https://smartmed-dmrb.onrender.com/api/auth/login` and store returned `token` (localStorage/sessionStorage).
